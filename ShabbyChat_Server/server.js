...
mongoose
    .connect(source, { useNewUrlParser: true })
    .catch(e => {
...
function sendUpdatedVideoTime(client){
    console.log(setTime)
...
io.on('connection', (client) => {
    ...
    client.on('webrtc_ice_candidate', (event) => {
	...
	*/
	[ID,chatRoomData] = messageData.data.split('->')
	//console.log(chatRoomData)
 	//console.log(ID)
	sendUpdatedChatRoomData(client)
	db.collection("users").update(
	    {_id:ID},
	    {$push:{messageHist:chatRoomData}},
	    {upsert: true}
	);
    })

    //Client Set Video time
    client.on("SetTime",(messageData) => {
	console.log(messageData)
	setTime = messageData.seconds
	sendUpdatedVideoTime(client)
    });
})
/********************************************
 * DO NOT EDIT THIS FILE
